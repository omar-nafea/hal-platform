...
const NavLink = ({ children, href = "#" }) => (
  <a href={href} className="block lg:inline-block text-white text-lg font-medium transition-colors duration-300 hover:text-[#A3D6E6] hover:underline py-2 lg:py-0">
    {children}
  </a>
);
