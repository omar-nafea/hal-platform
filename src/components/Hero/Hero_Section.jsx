...
const NavLink = ({ children, href = "#" }) => (
  <a
    href={href}
    className="text-white text-lg font-medium transition-colors duration-300 hover:text-[#A3D6E6] hover:underline"
  >
    {children}
  </a>
);
...
const Hero = () => {
  return (
    <div
      className="relative bg-cover bg-center bg-no-repeat text-white min-h-screen flex flex-col"
      // add background image from ../assets/bghero.png
      ...
      dir="rtl" // Set direction to Right-to-Left for Arabic content
    >
      {/* Overlay for better text readability */}
      <div className="absolute inset-0 bg-black opacity-40"></div>

      {/* Header/Navigation */}
      <header className="relative z-10 w-full py-6 px-4 sm:px-8 lg:px-16">
        <nav className="container mx-auto flex justify-between items-center">
          ...
          <div className=" flex items-center gap-14">
            ...
            <a
              href="#"
              className=" flex hover:text-white text-black items-center gap-4 px-4 py-4 border-2 bg-white hover:border-white rounded-full text-lg font-semibold transition-all duration-300 hover:bg-transparent hover:scale-101"
            >
              <span className="mr-2   text-xl">تواصل معنا</span>
      ...
      <main className="relative z-10 flex-grow flex items-center w-full">
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 items-center ">
          ...
          <div className="flex flex-col items-start">
            <h1 className="text-4xl sm:text-5xl lg:text-7xl leading-8 font-extrabold ">
              نُطوِّر أعمالك بحلول ذكاء
              <br />
              اصطناعي مبتكرة
            </h1>
            ...
            <div className="mt-10 ">
              <a
                ...
                className=" flex hover:text-white text-black items-center gap-4 px-4 py-4 border-2 bg-white hover:border-white rounded-full text-lg font-semibold transition-all duration-300 hover:bg-transparent hover:scale-101"
              >
                <span className="mr-2   text-xl">ابدء رحلتك الان!</span>
                <div className="bg-[#013366] text-white p-2 hover:scale-102 rounded-full p-1 ">
                  <ArrowIcon />
                </div>
              </a>
          ...
          <div className="lg:absolute left-20 top-1/4 ">
            <img
              ...
              alt="AI Robotic Hand"
              // On small screens remove heavy rotation and mirror on Y axis; on lg keep rotation and normal orientation

              className="w-full max-w-2xl h-auto transform -scale-x-150 sm:scale-x-100 md:scale-x-100 lg:scale-y-150"
